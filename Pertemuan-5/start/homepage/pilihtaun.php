...
?>
 ...
 <div class="row">
 <div class="col-lg-3">
	<form name="frmbspot" action="index.php?nav=evabaskur" method="post">
			...
			<div class="panel panel-default">
				...
				<?php
					echo"<select name='tahun' id='tahun' class='form-control'>
						...
						$tahun = mysql_query("SELECT Distinct TAHUNANGKATAN as tahunn FROM esiaa Where TAHUNANGKATAN >= 2014 order by TAHUNANGKATAN asc");
